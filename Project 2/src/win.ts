...
export class winGame extends PIXI.Container{
    ...
    constructor(app: PIXI.Application, game: Game){
        ...
        this.currencyText.x = this.app.screen.width * 0.36;
        this.currencyText.y = this.app.screen.height * 0.44;
        
        this.scoreText = new PIXI.Text('Score: ', this.Game.scoreStyle);
        this.scoreText.x = this.app.screen.width * 0.36;
        this.scoreText.y = this.app.screen.height * 0.38;  
        ...
        this.scoreNumber.y = this.app.screen.height * 0.38;
        ...
        this.currencyNumber.y = this.app.screen.height * 0.44;
